...
- Sometimes the numbers don't make sense.
    - We've seen this plugging in $x=0$ for our intercept.
- Sometimes there are other issues that are a little trickier to notice.

## Prediction: Some Notes

Suppose we have the line $$\hat{y} = 2.66 + 0.181x$$ and we wanted to predict the value of $y$ when $x=0.1$: $$\hat{y} = 2.66 + 0.181\times0.1 = 2.67$$
...
This is what we call *extrapolation*, applying a model estimate for values outside of the data's range for $x$. 

- Make sure you check the range for $x$ before making predictions!
