---
title: "5.2 The Binomial Distribution"
...
1. Check assumptions.
    a. Exactly $n$ trials to be performed.
    b. Two possible outcomes for each trial.
    c. Trials are independent (each trial does not impact the result of the next)
    d. Success probability $p$ remains the same from trial to trial.
